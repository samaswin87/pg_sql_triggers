...
RSpec.describe PgSqlTriggers::Migrator do
  ...
  describe ".migrations_path" do
    it "returns the correct path" do
      expect(PgSqlTriggers::Migrator.migrations_path).to eq(Rails.root.join("db", "triggers"))
    end
  end
  ...
  describe ".migrations_table_exists?" do
    it "returns true when table exists" do
      PgSqlTriggers::Migrator.ensure_migrations_table!
      expect(PgSqlTriggers::Migrator.migrations_table_exists?).to be true
    end

    it "returns false when table doesn't exist" do
      ActiveRecord::Base.connection.execute("DROP TABLE IF EXISTS trigger_migrations")
      expect(PgSqlTriggers::Migrator.migrations_table_exists?).to be false
      PgSqlTriggers::Migrator.ensure_migrations_table!
    end
  end
  ...
  describe ".ensure_migrations_table!" do
    ...
    it "does nothing if table already exists" do
      PgSqlTriggers::Migrator.ensure_migrations_table!
      expect { PgSqlTriggers::Migrator.ensure_migrations_table! }.not_to raise_error
    end
  end
  ...
  describe ".current_version" do
    ...
    it "returns the latest migration version" do
      ...
      expect(PgSqlTriggers::Migrator.current_version).to eq(20231215120002)
    end
  end
  ...
  describe ".migrations" do
    it "returns empty array when migrations directory doesn't exist" do
      ...
      expect(PgSqlTriggers::Migrator.migrations).to eq([])
    end
    ...
    it "parses migration files correctly" do
      ...
      migrations = PgSqlTriggers::Migrator.migrations
  ...
  describe ".run_up" do
    context "when applying all pending migrations" do
      ...
      it "applies all pending migrations" do
        ...
        expect(PgSqlTriggers::Migrator.current_version).to eq(20231215120001)
    ...
    context "when applying specific version" do
      ...
      it "applies only the specified migration" do
        PgSqlTriggers::Migrator.ensure_migrations_table!
        PgSqlTriggers::Migrator.run_up(20231215120002)
      ...
      it "raises error if migration doesn't exist" do
        expect {
          PgSqlTriggers::Migrator.run_up(99999999999999)
      ...
      it "raises error if migration already applied" do
        ...
        expect {
          PgSqlTriggers::Migrator.run_up(20231215120001)
  ...
  describe ".run_down" do
    ...
    it "returns early when no migrations exist" do
      PgSqlTriggers::Migrator.run_down
      expect(PgSqlTriggers::Migrator.current_version).to eq(0)
      expect { PgSqlTriggers::Migrator.run_down }.not_to raise_error
    end
    ...
    context "when rolling back to specific version" do
      ...
      it "rolls back to the specified version" do
        expect(PgSqlTriggers::Migrator.current_version).to eq(20231215120003)
        PgSqlTriggers::Migrator.run_down(20231215120002)
        expect(PgSqlTriggers::Migrator.current_version).to eq(20231215120002)
      end

      it "raises error if version not found or not applied" do
        expect {
          PgSqlTriggers::Migrator.run_down(99999999999999)
  ...
  describe ".status" do
    ...
    it "returns status for all migrations" do
      ...
      status = PgSqlTriggers::Migrator.status
  ...
  describe ".cleanup_orphaned_registry_entries" do
    ...
    it "removes registry entries for triggers that don't exist in database" do
      ...
      PgSqlTriggers::Migrator.cleanup_orphaned_registry_entries
